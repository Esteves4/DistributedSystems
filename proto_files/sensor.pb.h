...
typedef enum _Sensor_SensorType {
    ...
    Sensor_SensorType_GAS = 3
} Sensor_SensorType;
#define _Sensor_SensorType_MIN Sensor_SensorType_TEMPERATURE
#define _Sensor_SensorType_MAX Sensor_SensorType_GAS
#define _Sensor_SensorType_ARRAYSIZE ((Sensor_SensorType)(Sensor_SensorType_GAS+1))
